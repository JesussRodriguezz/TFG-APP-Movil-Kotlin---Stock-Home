...
data class Nutrients(
    @SerializedName("energy-kcal_100g") val energyKcal100g: Float? = 0.0f,
    @SerializedName("energy-kcal_serving") val energyKcalServing: Float? = 0.0f,
    @SerializedName("energy-kcal_unit") val energyKcalUnit: String? = "",
    @SerializedName("fat_100g") val fat100g: Float? = 0.0f,
    @SerializedName("fat_serving") val fatServing: Float? = 0.0f,
    @SerializedName("fat_unit") val fatUnit: String? = "",
    @SerializedName("saturated-fat_100g") val saturatedFat100g: Float? = 0.0f,
    @SerializedName("saturated-fat_serving") val saturatedFatServing: Float? = 0.0f,
    @SerializedName("saturated-fat_unit") val saturatedFatUnit: String? = "",
    @SerializedName("carbohydrates_100g") val carbohydrates100g: Float? = 0.0f,
    @SerializedName("carbohydrates_serving") val carbohydratesServing: Float? = 0.0f,
    @SerializedName("carbohydrates_unit") val carbohydratesUnit: String? = "",
    @SerializedName("salt_100g") val salt100g: Float? = 0.0f,
    @SerializedName("salt_serving") val saltServing: Float? = 0.0f,
    @SerializedName("salt_unit") val saltUnit: String? = "",
    @SerializedName("proteins_100g") val proteins100g: Float? = 0.0f,
    @SerializedName("proteins_serving") val proteinsServing: Float? = 0.0f,
